            ...
            <div style={{
              ...
              <button
                ...
                onClick={() => {
                  ...
                  const msg = `${currentStore.name || ''}\nDécouvrez nos produits et services en ligne !\n\n${url}`
              ...
              <button
                ...
                onClick={async () => {
                  const url = `${window.location.origin}/catalog?store=${currentStore.id}`
                  if (navigator.share) {
                    navigator.share({ title: currentStore.name || '', text: 'Découvrez nos produits et services en ligne !', url }).catch(() => {})
                  } else {
